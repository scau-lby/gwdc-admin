var JSPlayerModule = (function () {
  ...
  return function (JSPlayerModule) {
    ...
    var PThread = {
      ...
      threadInit: function () {
        for (let i = 0; i < PThread.tlsInitFunctions.length; i++) {
    ...
    function _AdditionDataCB(port, pstAddDataInfo) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(1, 0, port, pstAddDataInfo);
    ...
    function _atexit(func, arg) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(4, 1, func, arg);
    }
    ...
    function ___pthread_create_js(pthread_ptr, attr, start_routine, arg) {
      ...
      for (var i in offscreenCanvases) {
        GROWABLE_HEAP_I32()[(offscreenCanvases[i].canvasSharedPtr + 8) >> 2] =
          pthread_ptr;
      }
      var threadParams = {
        stackBase: stackBase,
    ...
    function _alListenerfv(param, pValues) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(18, 1, param, pValues);
      if (!AL.currentCtx) {
        return;
      }
      if (!pValues) {
    ...
    function _alcCreateContext(deviceId, pAttrList) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(25, 1, deviceId, pAttrList);
    ...
    function _alcGetString(deviceId, param) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(27, 1, deviceId, param);
    ...
    function _alcMakeContextCurrent(contextId) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(28, 1, contextId);
      if (contextId === 0) {
        AL.currentCtx = null;
        return 0;
      } else {
    ...
    function _alcOpenDevice(pDeviceName) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(29, 1, pDeviceName);
      if (pDeviceName) {
    ...
    function _emscripten_webgl_destroy_context_main_thread(a0) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(32, 1, a0);
      return _emscripten_webgl_destroy_context_calling_thread(a0);
    }
    function _emscripten_webgl_destroy_context_before_on_calling_thread(
      contextHandle
    ) {
      if (_emscripten_webgl_get_current_context() == contextHandle)
        _emscripten_webgl_make_context_current(0);
    }
    ...
    function _fd_close(fd) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(35, 1, fd);
      try {
        var stream = SYSCALLS.getStreamFromFD(fd);
        FS.close(stream);
        return 0;
    ...
    var proxiedFunctionTable = [
      ...
      _emscripten_webgl_destroy_context_main_thread,
      _environ_get,
      _environ_sizes_get,
      _fd_close,
      _fd_read,
    ...
    var _malloc = (Module["_malloc"] = function () {
      return (_malloc = Module["_malloc"] = Module["asm"]["bd"]).apply(
        null,
        arguments
      );
    });
    ...
    var stackSave = (Module["stackSave"] = function () {
      return (stackSave = Module["stackSave"] = Module["asm"]["gd"]).apply(
        null,
        arguments
      );
    });
    ...
    var stackAlloc = (Module["stackAlloc"] = function () {
      return (stackAlloc = Module["stackAlloc"] = Module["asm"]["id"]).apply(
        null,
        arguments
      );
    });
    ...
    var _setThrew = (Module["_setThrew"] = function () {
      return (_setThrew = Module["_setThrew"] = Module["asm"]["kd"]).apply(
        null,
        arguments
      );
    });
    var _free = (Module["_free"] = function () {
      return (_free = Module["_free"] = Module["asm"]["ld"]).apply(
        null,
        arguments
      );
    });
    var _memalign = (Module["_memalign"] = function () {
      return (_memalign = Module["_memalign"] = Module["asm"]["md"]).apply(
        null,
        arguments
      );
    });
